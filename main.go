...
func main() {
	var (
		...
		ver       = flag.Bool("version", false, "print version and exit") // Add version flag
	)
	flag.Parse()

	// Check if version flag is set
	if *ver {
		fmt.Printf("gencodec %s\n", version)
		os.Exit(0)
	}
...
func generate(mtyp *marshalerType, cfg *Config) ([]byte, error) {
	w := new(bytes.Buffer)
	fmt.Fprint(w, "// Code generated by github.com/tomisetsu/gencodec. DO NOT EDIT.\n\n")
